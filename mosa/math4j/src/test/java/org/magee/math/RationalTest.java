...
public class RationalTest {
     ...
     * 2. {@link Rational#multiply(Rational)} divides the numerators instead of multiplying them.
     */
    @Test
     ...
     * {@link Rational#add(long)} has a bug when converting the long into a Rational, as it uses 0 as a denominator, raising NumberFormatException in every case!
     */
    @Test
